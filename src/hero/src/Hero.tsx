...
export function Hero({
	...
	return (
		<section className="anvilkit-hero">
			...
			<div className="anvilkit-hero__theme relative z-10 mx-auto flex min-h-[38rem] max-w-[110rem] flex-col items-center px-4 pb-20 pt-16 text-center sm:min-h-[44rem] sm:px-6 sm:pb-24 sm:pt-20 lg:min-h-[52rem] lg:px-8 lg:pb-[22rem] lg:pt-32">
