...
const usesNamedFlags =
	...
	turboArgs.some(
		(argument) =>
			argument === "--template" || argument.startsWith("--template="),
	) ||
	turboArgs.some(
		(argument) => argument === "--label" || argument.startsWith("--label="),
	) ||
	turboArgs.some(
		(argument) =>
			argument === "--category" || argument.startsWith("--category="),
	);
...
const result = spawnSync(
	turboBinary,
	["gen", "component", ...resolvedTurboArgs],
	{
		env: sanitizedEnv,
		stdio: "inherit",
	},
