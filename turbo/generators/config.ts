...
export default function generator(plop: PlopTypes.NodePlopAPI): void {
  ...
  plop.setGenerator('component', {
    description: 'Create a Puck-native publishable component package in src/<name>',
    prompts: [
      {
        type: 'input',
        name: 'name',
        ...
        validate: (input: string) => {
          try {
            ...
            return error instanceof Error ? error.message : 'Invalid component name.';
          }
        },
      },
      {
    ...
    actions: (answers) => {
      ...
      const suggestedCategory = getSuggestedCategory(answers?.suggestedCategory);
